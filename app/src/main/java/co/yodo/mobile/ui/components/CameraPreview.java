...
public class CameraPreview extends ViewGroup implements SurfaceHolder.Callback {
	...
	public CameraPreview(Context context, AttributeSet attrs) {
		...
		mSurfaceView.setOnLongClickListener(new OnLongClickListener(){
			...
			public boolean onLongClick(View v) {
				mFrameCallback.input.resetFlag = true;
				return true;
			}
		...
		mSurfaceView.setOnClickListener(new OnClickListener(){
			public void onClick(View v) {
				mFrameCallback.input.enrollFlag = true;
			}
		});
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		try {
			...
			Timber.e( "IOException caused by setPreviewDisplay() : " + exception.getMessage() );
		}
	}
	...
	public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
		...
		Timber.e( "Preview size: width = " + params.imageWidth + " height = " + params.imageHeight );

		//4. Initialize API 
		InitState state = VerificationAPI.initialize( params );

		Timber.e( "InitState: " + state );
		Timber.e( "Version string: " + VerificationAPI.getVersion() );
	...
	private void updateDB() {
		mFrameCallback.input.enrollFlag = false;
		mFrameCallback.input.numberOfItems = VerificationAPI.getNbrOfDBItems();
