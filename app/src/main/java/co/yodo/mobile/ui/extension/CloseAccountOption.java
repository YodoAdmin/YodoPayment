 ...
 */
public class CloseAccountOption extends IOption {
    /**
     * Sets up the main elements of the options
     * @param activity The Activity to handle
     */
    public CloseAccountOption( MainActivity activity ) {
        super( activity );
    }
    ...
    public void execute() {
        ...
        final String message = this.mActivity.getString( R.string.close_message );
        ...
        View.OnClickListener positiveClick = new View.OnClickListener() {
            ...
            public void onClick( View view ) {
                ...
                if( validator.validate() ) {
                    ...
                    ( (MainActivity) mActivity).closeAccount( etInput );
                }
            }
        };
