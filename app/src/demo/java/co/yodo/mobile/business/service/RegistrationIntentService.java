...
public class RegistrationIntentService extends IntentService {
    ...
    /**
     * It is used to send the uuid token, to register the gcm_id
    ...
    public static void newInstance(Context context, String uuidToken) {
        Intent intent = new Intent(context, RegistrationIntentService.class);
        intent.putExtra(BUNDLE_UUID, uuidToken);
    ...
    protected void onHandleIntent(Intent intent) {
        try {
            String uuidToken = intent.getStringExtra(BUNDLE_UUID);
