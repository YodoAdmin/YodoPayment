...
public class CouponsDataSource {
	...
	private String[] allColumns = {CouponsSQLiteHelper.COLUMN_ID, CouponsSQLiteHelper.COLUMN_URL, 
			CouponsSQLiteHelper.COLUMN_DESCRIPTION, CouponsSQLiteHelper.COLUMN_CREATED};
