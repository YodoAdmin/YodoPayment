...
public class CouponsSQLiteHelper extends SQLiteOpenHelper {
    ...
    String sqlCreate = "CREATE TABLE " + TABLE_COUPONS + " (" + COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + 
    		COLUMN_DESCRIPTION + " TEXT, " + COLUMN_URL + " TEXT, " + COLUMN_CREATED + " DATETIME)";
